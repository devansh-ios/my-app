...
console.log(user)
useEffect(()=>{
const checkEmailVerificationAndRedirect = async () => {
  try {
    if (user) {
...
// Call the function to check email verification and redirect
checkEmailVerificationAndRedirect();
}, [user, router]);


 return (
    <div className="sign_container">
      <div className="side_blackContainer">
        <span>Board.</span>
      </div>
      ...
      <div className="form">
        ...
        <div className="btn">
          ...
          <button ><svg xmlns="http://www.w3.org/2000/svg" width="12" height="14" viewBox="0 0 12 14" fill="none">
